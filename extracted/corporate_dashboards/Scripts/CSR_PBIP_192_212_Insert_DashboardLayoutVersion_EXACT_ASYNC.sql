...
/*
    Inserts/updates the 21 CSR/PBIP exact-layout tab versions into the existing
    ...
    Each version contains one full-page custom HTML tile; internal visuals retain exact PBIP coordinates and slicers.
