(function () {
    ...
    async function load() {
        ...
        try {
            // CLONE PATCH: fetch from static JSON instead of MVC endpoint.
            // Original .NET: ../Dashboard/GetExecutiveVersionData?version=<suite>
            const endpoint = new URL('../data/executive/' + suite + '.json', window.location.href);
